...
- производен клас **Car** , описващ автомобил, който има допълнителни член-данни за мощност (цяло число киловати) и обем на двигателя (цяло число cm) Да се дефинират двете операции print и get_perf , като:
